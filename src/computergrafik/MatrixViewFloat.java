...
/**
 * Anzeige einer Matrix mit formatierten float-Werten
 * 
...
public class MatrixViewFloat extends JPanel {
	 ...
	 * 
	 * @param array  anzuzeigendes float Array
	 */
	 ...
	 * 
	 * @param array  anzuzeigendes float Array
	 * @param title  Ueberschrift der Anzeige
	 */
...
//		gl.setVgap(5);
		...
		Font f1 = new Font(border.getTitleFont().getFontName(), Font.PLAIN, 16);
